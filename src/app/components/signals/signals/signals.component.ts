...
export class SignalsComponent {
  ...
  /* 
    effect - raramente são necessários na maioria dos códigos, mas podem ser úteis
    em circunstancias específicas.

    - Registro de dados sendo exibidos e quando eles mudam, seja para análise
    ou como ferramenta de depuração.

    - Manter os dados sincronizados com window.localStorage.
